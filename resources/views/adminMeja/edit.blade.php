...
<div class="form-wrapper">
    <div class="form-container">
        ...
        <div class="form-header">
            ...
            <div>
                <a href="{{ route('admin.meja.index') }}" class="form-btn form-btn-secondary">
                    Kembali
                </a>
            </div>
        </div>
        ...
        <div class="form-card">
            ...
            <div class="form-card-body">
                <form action="{{ route('admin.meja.update', $meja->id) }}" 
                      method="POST" 
                    ...
                    <!-- Row 1: Nama Meja & Lantai -->
                    <div class="form-row">
                        <div class="form-col-6">
                            <div class="form-group">
                                <label for="nama_meja" class="form-label">
                                    Nama Meja <span class="form-required">*</span>
                                </label>
                                <input type="text" 
                                       class="form-input @error('nama_meja') form-input-error @enderror" 
                                       id="nama_meja" 
                                       name="nama_meja" 
                                       value="{{ old('nama_meja', $meja->nama_meja) }}" 
                                       placeholder="Contoh: Meja VIP 1, Meja A" 
                                       required>
                        ...
                        <div class="form-col-6">
                            <div class="form-group">
                                <label for="lantai" class="form-label">
                                    Lantai <span class="form-required">*</span>
                                </label>
                                <select class="form-select @error('lantai') form-input-error @enderror" 
                                        id="lantai" 
                                        name="lantai" 
                                        required>
                                    <option value="1" {{ old('lantai', $meja->lantai ?? '1') == '1' ? 'selected' : '' }}>
                                        Lantai 1
                                    </option>
                                    <option value="2" {{ old('lantai', $meja->lantai ?? '1') == '2' ? 'selected' : '' }}>
                                        Lantai 2
                                    </option>
                                    <option value="3" {{ old('lantai', $meja->lantai ?? '1') == '3' ? 'selected' : '' }}>
                                        Lantai 3
                                    </option>
                                </select>
                                @error('lantai')
                        ...
                        <div class="form-col-6">
                            <div class="form-group">
                                ...
                                <select class="form-select @error('status') form-input-error @enderror" 
                                        ...
                                        name="status" 
                                        required>
                                    <option value="available" {{ old('status', $meja->status) == 'available' ? 'selected' : '' }}>
                                        Tersedia
                                    </option>
                                    <option value="occupied" {{ old('status', $meja->status) == 'occupied' ? 'selected' : '' }}>
                                        Terisi
                                    </option>
                                    <option value="maintenance" {{ old('status', $meja->status) == 'maintenance' ? 'selected' : '' }}>
                                        Maintenance
                                    </option>
                                    <option value="reserved" {{ old('status', $meja->status) == 'reserved' ? 'selected' : '' }}>
                                        Reserved
                                    </option>
                                </select>
                                @error('status')
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" 
                               class="form-file @error('foto') form-input-error @enderror" 
                               id="foto" 
                               name="foto" 
                               accept="image/*">
                        <div class="form-help">
    ...
    $('#foto').change(function() {
        ...
        if (file) {
            ...
            reader.onload = function(e) {
                ...
                $('.image-preview:not(.current-image)').remove();
